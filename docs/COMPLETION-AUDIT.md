...
- Descriptor parser backends now have explicit validation and `--list-backends` discovery. `heuristic` is implemented; `tree-sitter` remains a planned candidate and fails validation until implemented.
